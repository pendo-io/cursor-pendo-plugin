...
**Authoritative:** `templateJson` JSON Schema on `Pendo:createOrchestrateJourneyFromJson` (fields, enums, wait
...
|------------------------------|---------|
| Single email, built-in graph (marketing) | Built-in template — see `references/intake.md` for `Pendo:createOrchestrateJourneyFromTemplate` |
...
All custom graphs use `Pendo:createOrchestrateJourneyFromJson` — see `references/intake.md`.
